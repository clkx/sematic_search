...
from sematic_search import semantic_search_by_prompt as ss_by_prompt, semantic_search_by_name as ss_by_name
import uvicorn
import os
...
@app.get("/items/{id}", response_model=GeneratedMusic)
...
@app.get("/ssearch/prompt/{prompt}", response_model=List[GeneratedMusic])
